          ...
          <div class="row pb-1">
            <div class="col-3 offset-2 text-end">
              <select class="form-select" name="xplayoffmode" onChange="dolmoedit()">
                <option value="0"<?php if ($playoffmode==0) echo " selected";?>><?php echo $text[802]?></option>
                <option value="1"<?php if ($playoffmode==1) echo " selected";?>><?php echo $text[803]?></option>
              </select>
            </div>
            <div class="col-5 text-start"><acronym title="<?php echo $text[801];?>"><?php echo $text[800];?></acronym></div>
          <?php }
  } elseif ($show==2) {
    if($_SESSION['lmouserok']==2 || $_SESSION['lmouserokerweitert']==1){ ?>
          <div class="row pb-1">
