...
include (PATH_TO_ADDONDIR . '/tipp/lmo-tippsendmail.php');
...
if ($newpage == 1) {
    ...
    include (PATH_TO_ADDONDIR . '/tipp/lmo-admintippverify.php');
}
// end ($newpage==1)
...
?>
    ...
    require (PATH_TO_ADDONDIR . '/tipp/lmo-tippnewdir.php'); ?></div>
     </div>
     <div class="row p-1">
