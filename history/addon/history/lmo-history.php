...
if (file_exists(PATH_TO_LMO . '/' . $diroutput . $m_liga . '-tab.csv')) {
    ...
    switch ($m_sort) {
        case (0):
            ...
            break;
        case (1):
            usort($m_tabelle, 'cmp1');
            break;
        case (2):
            usort($m_tabelle, 'cmp2');
            break;
        case (3):
            usort($m_tabelle, 'cmp3');
            break;
        case (4):
            usort($m_tabelle, 'cmp4');
            break;
        case (5):
            usort($m_tabelle, 'cmp5');
            break;
        case (6):
            usort($m_tabelle, 'cmp6');
            break;
        case (7):
            usort($m_tabelle, 'cmp7');
            break;
        case (8):
            usort($m_tabelle, 'cmp8');
            break;
    }
    ...
    for ($j = 0; $j < $m_anzteams; $j++) {
        ...
        if (($m_diff = $m_tabelle[$j][4] - $m_tabelle[$j][5]) > 0)
            $m_diff = '+' . $m_diff;
